 ...
 * Ork class
 *
 * Muscular humanoids, with green skin and a penchant for violence.
 * The orks live for war and constantly fight anything in sight, including each other.
 *
...
public class Ork extends Character {
    ...
    public String toString() {
        return "Ork {" + "health=" + this.getHealth() + ", name='" + this.getName() + '\'' + ", attributes=" + this.getAttributes()
