...
public class Barbarian implements Character {
	...
	private int experiencePoints; // experiencePoints points for a barbarian -
									// will level up every 100 points

	@Override
	public Character fight(Character char2) {
		if (this instanceof Barbarian && char2 instanceof Barbarian) {
			Barbarian barbarian1 = this;
	...
	public String toString() {
		return "Barbarian{" + "health=" + health + ", name='" + name + '\'' + ", attributes=" + attributes
